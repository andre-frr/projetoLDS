...
INSERT INTO departamento (nome, sigla) VALUES ('Engenharia', 'ENG');
INSERT INTO area_cientifica (nome, sigla, id_dep) VALUES ('Informática', 'INF', 1);
INSERT INTO curso (nome, sigla, tipo) VALUES ('Licenciatura em Informática', 'LIC-INF', 'LIC');
INSERT INTO uc (nome, id_curso, id_area, ano_curso, sem_curso, ects, horas_totais)
VALUES ('Base de Dados', 1, 1, 2, 1, 6.0, 50);

INSERT INTO uc_horas_contacto (id_uc, tipo, horas) VALUES
  (1,'PL',15), (1,'T',15), (1,'TP',20);  -- soma = 50 (passa no trigger)
